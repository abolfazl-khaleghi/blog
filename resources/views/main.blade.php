            ...
            <li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                ...
                <div class="slider_text_box">
                    <div class="tp-caption tp-resizeme first_text"
                         ...
                         data-textAlign="['left','left','left','left','left','center']">یک قالب قدرتمند <br />برای استارتاپ شما</div>
                    ...
                    <div class="tp-caption tp-resizeme secand_text"
                         ...
                         data-textAlign="['left','left','left','left','left','center']">همین حالا دانلود کنید!
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme"
                         ...
                         data-responsive_offset="on"
                         data-frames="[{&quot;delay&quot;:10,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;&quot;,&quot;mask&quot;:&quot;x:0px;y:[100%];s:inherit;e:inherit;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;y:[175%];&quot;,&quot;mask&quot;:&quot;x:inherit;y:inherit;s:inherit;e:inherit;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;}]">
                        <a class="more_btn" href="#">توضیحات بیشتر</a>
                    </div>
                    <div class="tp-caption tp-resizeme single_img"
                        ...
                        <img src="pics/home-slider/slider-m-1.png" alt="">
                    </div>
                </div>
            </li>
            ...
            <li data-index="rs-1589" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                ...
                <div class="slider_text_box">
                    <div class="tp-caption tp-resizeme first_text"
                         ...
                         data-responsive_offset="on"
                         data-frames="[{&quot;delay&quot;:10,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;&quot;,&quot;mask&quot;:&quot;x:0px;y:0px;s:inherit;e:inherit;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;y:[175%];&quot;,&quot;mask&quot;:&quot;x:inherit;y:inherit;s:inherit;e:inherit;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;}]"
                         data-textAlign="['left','left','left','left','left','center']">یک قالب قدرتمند <br >برای استارتاب شما</div>
...
<section class="feature_area">
    <div class="container">
        <div class="c_title">
            <img src="pics/icon/title-icon.png" alt="">
            <h6>ویژگی های منحصر به فرد این قالب که می توانید</h6>
            <h2>متمایز با دیگران باشید</h2>
        </div>
        <div class="row feature_inner">
            <div class="col-lg-4 col-sm-6">
                <div class="feature_item">
                    <div class="f_icon">
                        <img src="pics/icon/f-icon-1.png" alt="">
                    </div>
                    <h4>معرفی حرفه ای برند</h4>
                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                    <a class="more_btn" href="#">بیشتر بدانید</a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6">
                <div class="feature_item">
                    <div class="f_icon">
                        <img src="pics/icon/f-icon-2.png" alt="">
                    </div>
                    <h4>بازاریابی دیجیتال</h4>
                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                    <a class="more_btn" href="#">بیشتر بدانید</a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6">
                <div class="feature_item">
                    <div class="f_icon">
                        <img src="pics/icon/f-icon-3.png" alt="">
                    </div>
...
<section class="best_3d_area">
    <div class="left_3d">
        <div class="shap_slider_inner owl-carousel">
            <div class="item">
                <h4>““شما بهترین هستید””</h4>
                <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.</p>
                <div class="media">
                    <img src="pics/team/people/people-5.jpg" alt="">
                    <div class="media-body">
                        <h5>نام و نام خانوادگی</h5>
                        <h6>طراح و توسعه دهنده</h6>
                    </div>
                </div>
            </div>
            <div class="item">
    ...
    <div class="right_text">
        <div class="right_text_inner">
            <div class="text_3d">
                <div class="l_title">
                    <img src="pics/icon/title-icon.png" alt="">
                    <h6>برترین امکانات</h6>
                    <h2>ما مخفی نمی شویم، چون بهترین ها را ارائه می دهیم.</h2>
                </div>
                <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد.</p>
            </div>
            <div class="shap_mobile">
                <img src="pics/iphone4.png" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="team_people_text">
                    <div class="l_title">
                        <img src="pics/icon/title-icon.png" alt="">
                        <h6>برتری های خدمات ما</h6>
                        <h2>تیمی از افراد با تجربه و متخصص در این زمینه</h2>
                    </div>
                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد.</p>
                    <ul>
                        <li><a href="#">بیش از 10 سال سابقه فعالیت حرفه ای</a></li>
                        <li><a href="#">بیش از 50 نمونه طراحی سایت</a></li>
                        <li><a href="#">تیمی متخصص و خوش ذوق</a></li>
                        <li><a href="#">طراحی و پیاده سازی همگام با تکنولوژی</a></li>
                        <li><a href="#">ارائه بیش از 100 محصول متنوع</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="pics/team/people/people-1.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="pics/team/people/people-2.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="pics/team/people/people-3.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-6">
                            <div class="team_img_item">
                                <img src="pics/team/people/people-4.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row get_touch_inner">
            ...
            <div class="col-lg-6">
                <div class="touch_details">
                    <div class="l_title">
                        <img src="pics/icon/title-icon.png" alt="">
                        <h6>در ارتباط باشید</h6>
                        <h2>لطفا نظرات و پیشنهادات خود را برای ما ارسال کنید.</h2>
                    </div>
                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
                    <a href="#"><h5>با ما تماس بگیرید</h5></a>
                    <a href="#"><h4>+987132309534</h4></a>
                </div>
            </div>
        </div>
    </div>
...
<section class="world_map_area p_100">
    <div class="container">
        <div class="world_map_inner">
            <img class="img-fluid" src="pics/world-map.png" alt="">
            <div class="bd-callout">
                <h3>دفتر مرکزی</h3>
                <h4><a href="#">+9832309534</a> <a href="#">info@webrubik.com</a></h4>
                <p>شیراز، بلوار جام جم</p>
            </div>
        </div>
    </div>
</section>
