<header class="main_menu_area">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item active"><a class="nav-link" href="index.html">صفحه نخست</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="portfolio.html">رزومه</a></li>
        ...
        <a class="navbar-brand" href="#"><img src="pics/logo.png" alt="" width="75px" height="75px"></a>
